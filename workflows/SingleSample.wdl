...
workflow SingleSample {
  ...
  if (realign) {
    ...
    if (defined(target_interval_list)) {
      ...
      File wes_contamination_sites_ud = GenerateSubsettedContaminationResources.subsetted_contamination_ud
      File wes_contamination_sites_bed = GenerateSubsettedContaminationResources.subsetted_contamination_bed
      File wes_contamination_sites_mu = GenerateSubsettedContaminationResources.subsetted_contamination_mu
    }
    ...
    call Alignment.Alignment {
      input:
        ...
        contamination_sites_ud = select_first([wes_contamination_sites_ud, contamination_sites_ud]),
        contamination_sites_bed = select_first([wes_contamination_sites_bed, contamination_sites_bed]),
        contamination_sites_mu = select_first([wes_contamination_sites_mu, contamination_sites_mu]),
  ...
  output {
    ...
    File? alignment_md5 = alignment_md5_to_output
